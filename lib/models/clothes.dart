...
class Clothes {
  ...
  static List<Clothes> generateClothes() {
    return [
      Clothes('Комбинезон из бархата \n             с бантом',
          'YVES SAINT LAURENT', '\$2851.02', 'assets/images/ysl1.png', [
        'assets/images/ysl1.png',
        'assets/images/ysl2.png',
        'assets/images/ysl3.png',
        'assets/images/ysl4.png',
      ]),
      Clothes(' Тренч Chelsea \n     из хлопка', 'BURBERRY', '\$2270.98',
          'assets/images/trench1.png', [
        'assets/images/trench1.png',
        'assets/images/trench2.png',
        'assets/images/trench3.png'
      ]),
      Clothes('     Шерстяной жакет\nс широкими лацканами', 'LORO PIANA',
          '\$3392.52', 'assets/images/loro1.png', [
        'assets/images/loro1.png',
        'assets/images/loro2.png',
        'assets/images/loro3.png'
      ]),
      Clothes('Шерстяная трикотажная\n        юбка с узорами', 'LOEWE',
          '\$1193.00', 'assets/images/loewe1.png', [
        'assets/images/loewe1.png',
        'assets/images/loewe2.png',
        'assets/images/loewe3.png'
      ]),
      Clothes(' Свитер из шерсти \n       и кашемира', 'JW ANDERSON',
          '\$835.64', 'assets/images/sweater1.png', [
        'assets/images/sweater1.png',
        'assets/images/sweater2.png',
        'assets/images/sweater3.png'
      ]),
      Clothes('Куртка-рубашка\n      из шерсти', 'ISABEL MARANT', '\$695.79',
      ...
      Clothes('Шерстяной бомбер\n     прямого кроя', 'HUGO BOSS', '\$755,82',
      ...
      Clothes('   Хлопковый свитшот\n для мальчиков 5-6 лет',
          'POLO RALPH LAUREN', '\$132.84', 'assets/images/prlbaby1.png', [
